...
export class GroupfriendsPage {
  ...
  ionViewWillEnter() {
    ...
    let index= this.myfriends.indexOf(this.newbuddy);
    if(index>-1){
      this.myfriends.splice(index,1);
    }


      //this.myfriends.splice(this.myfriends.indexOf(this.newbuddy.uid), 1);//od dolu gi brisit
      //this.myfriends.splice(this.newbuddy.uid, 1);//od gore gi brisit
